  ...
  return (
    <>
      {showModal ? (
        <ModalContainer
          ref={modalRef}
          className="absolute inset-0 flex justify-center items-center backdrop-opacity-10"
          style={{ backgroundColor: "rgba(0,0,0,0.5)" }}
          onClick={closeModal}
        >
            {/* <animated.div style={animation}> */}
          <Modal className="absolute top-40 z-[1]  w-[600px] bg-[#212736] p-md-4 rounded-md">
